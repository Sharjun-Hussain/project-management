    ...
    try {
      const url =
        formMode === "create"
          ...
          : `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/sub-categories/${selectedDomain.id}`;
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="animate-header">
            ...
            <div className="flex flex-col justify-center py-1">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Manage product domains and catalog organization.</p>
            </div>
          </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-4 mb-8">
                <p className="text-slate-500 dark:text-slate-400 text-sm font-medium leading-relaxed">
                  You are about to permanently delete <span className="text-slate-900 dark:text-white font-bold italic underline decoration-red-500/30 underline-offset-4">"{selectedDomain?.name}"</span>.
                </p>
